<?php /* Smarty version 2.6.26, created on 2012-02-16 17:10:31
  ...
  <div class="header clearfix">
    ...
    <div class="grid_2 center">
      <?php if ($this->_tpl_vars['post']->network == 'twitter' || $this->_tpl_vars['post']->network == 'google+'): ?>
        <?php if ($this->_tpl_vars['show_favorites_instead_of_retweets']): ?><?php if ($this->_tpl_vars['post']->network == 'google+'): ?>+1's<?php else: ?>favorites<?php endif; ?><?php else: ?><?php if ($this->_tpl_vars['post']->network == 'google+'): ?>reshares<?php else: ?>retweets<?php endif; ?><?php endif; ?>
     <?php else: ?>
        <?php if ($this->_tpl_vars['show_favorites_instead_of_retweets']): ?><?php if ($this->_tpl_vars['post']->network == 'google+'): ?>+1's<?php else: ?>likes<?php endif; ?><?php endif; ?>
     <?php endif; ?>
    </div>
